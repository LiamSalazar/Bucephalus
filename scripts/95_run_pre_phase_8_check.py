...
def main() -> None:
    ...
    required = [
        ...
        paths.evaluation_outputs / "markov_validation_report.json",
        paths.evaluation_outputs / "markov_state_distribution_comparison.csv",
        ...
        paths.calibration_outputs / "tactical_effect_uncertainty.json",
